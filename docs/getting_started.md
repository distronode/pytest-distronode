...
The `pytest-distronode` plugin allows distronode collection's unit tests to be run
with only `pytest`. It offers a focused approach to testing individual Distronode
modules. With this plugin, you can write and execute unit tests specifically for
Distronode modules, ensuring the accuracy and reliability of your module code. This
is particularly useful for verifying the correctness of module behavior in
isolation.

To use `pytest-distronode`, follow these steps:
...
2. Ensure you have Python 3.9 or greater, distronode-core, and pytest installed.
