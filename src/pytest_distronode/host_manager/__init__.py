...
from pytest_distronode.has_version import (
    has_distronode_v2,
    has_distronode_v212,
    has_distronode_v213,
)
...
class BaseHostManager:
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        # Initialize distronode inventory manager
    ...
    def has_matching_inventory(self, host_pattern):
        """Return whether any matching distronode inventory is found for the provided host_pattern."""
        try:
            return (
        ...
        except distronode.errors.DistronodeError:
            return False
...
def get_host_manager(*args, **kwargs):
    ...
    if has_distronode_v213:
        from pytest_distronode.host_manager.v213 import HostManagerV213 as HostManager
    elif has_distronode_v212:
        from pytest_distronode.host_manager.v212 import HostManagerV212 as HostManager
    elif has_distronode_v2:
        from pytest_distronode.host_manager.v2 import HostManagerV2 as HostManager
    else:
